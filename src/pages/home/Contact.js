          ...
          <form className='w-full' onSubmit={handleSubmit(onSubForm)}>
            <Row>
              <Col lg='3' className='mb-3 md:mb-2'>
                <input  {...register("name", { required: true, minLength: 2 })} className='form-control border-1 border-gray-400 focus:outline-none focus:border-slate-700 shadow bb-slate-600' name='name' placeholder='שם:' type='text' />
              </Col>
              <Col lg='6' className='mb-3'>
                <input  {...register("email", { required: true, minLength: 2 })} className='form-control border-1 border-gray-400 focus:outline-none focus:border-slate-700 shadow bb-slate-600 ' name='email' placeholder='מייל:' type='email' />
              </Col>
              <Col lg='3' className='mb-3 '>
                <input  {...register("phone", { required: true, minLength: 2 })} className='form-control border-1 border-gray-400 focus:outline-none focus:border-slate-700 shadow bb-slate-600 ' name='phone' placeholder='טל:' type='phone' />
              </Col>
            </Row>

            <textarea  {...register("message", { required: true, minLength: 2 })} className='form-control border-1 border-gray-400 focus:outline-none focus:border-slate-700 shadow bb-slate-600 ' id='message' name='message' placeholder='הודעה:' rows={5}></textarea>
            <br />
            <Row>
